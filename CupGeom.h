...
class CupGeometry : public GeometryHelper
{
	...
	void CreateGeometry(float height, int nDivisions)
	{
		...
		for (int i = 0; i < nDivisions; i++) // divide by two to get half the can
		{
...
public:
	CupGeometry(float height = 1.0f, int nDivisions = 16) { CreateGeometry(height, nDivisions); }
